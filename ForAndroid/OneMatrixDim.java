...
public class OneMatrixDim extends AppCompatActivity {

    //For the rest of the calculations that require ONE matrix
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_one_matrix_dim);
        ...
        matrixColumns.setAdapter(adapter2);
    }
