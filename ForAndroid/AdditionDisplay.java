...
public class AdditionDisplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addition_display);
        ...
        gd = (GridLayout) findViewById(R.id.gridA);
        gd.setRowCount(rows);
        ...
        for(int r = 0; r < rows; r++)
        {
            for(int c = 0; c < columns; c++)
            {
                ...
                strValue = Double.toString(sumMatrix[r][c]);
